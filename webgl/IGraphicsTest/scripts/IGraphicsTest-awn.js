class IGraphicsTestController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "IGraphicsTest", options);
  }

  static importScripts (actx) {
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IGraphicsTest/scripts/IGraphicsTest-wam.js").then(() => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IGraphicsTest/scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IGraphicsTest/scripts/IGraphicsTest-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
