class IPlugInstrumentController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "IPlugInstrument", options);
  }

  static importScripts (actx) {
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IPlugInstrument/scripts/IPlugInstrument-wam.js").then(() => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IPlugInstrument/scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule("https://iplug2.github.io/webgl/IPlugInstrument/scripts/IPlugInstrument-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
