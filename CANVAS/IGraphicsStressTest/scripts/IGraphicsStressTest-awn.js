class IGraphicsStressTestController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "IGraphicsStressTest", options);
  }

  static importScripts (actx) {
    var origin = "https://iplug2.github.io/CANVAS/IGraphicsTest/";
    ...
    return new Promise( (resolve) => {
      ...
      actx.audioWorklet.addModule(origin + "scripts/IGraphicsStressTest-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
