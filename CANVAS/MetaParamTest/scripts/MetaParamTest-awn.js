/* Declares the MetaParamTest Audio Worklet Node */

class MetaParamTestController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "MetaParamTest", options);
  }

  static importScripts (actx) {
    var origin = "https://iplug2.github.io/CANVAS/MetaParamTest/";

    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/MetaParamTest-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/MetaParamTest-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
