class IPlugFaustDSPController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "IPlugFaustDSP", options);
  }

  static importScripts (actx) {
    var origin = "https://iplug2.github.io/CANVAS/IPlugFaustDSP/";

    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/IPlugFaustDSP-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/IPlugFaustDSP-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
