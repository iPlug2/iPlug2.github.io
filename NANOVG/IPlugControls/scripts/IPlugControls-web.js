...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 77424,
    DYNAMIC_BASE = 5320304,
    DYNAMICTOP_PTR = 77264;
...
var wasmBinaryFile = 'IPlugControls-web.wasm';
...
var ASM_CONSTS = {
  3428: function() {if(Module.syncdone == 1) { Module.syncdone = 0; FS.syncfs(false, function (err) { assert(!err); console.log("Synced to IDBFS..."); Module.syncdone = 1; }); }},  
 3595: function($0) {var name = '/' + UTF8ToString($0) + '_data'; FS.mkdir(name); FS.mount(IDBFS, {}, name); Module.syncdone = 0; FS.syncfs(true, function (err) { assert(!err); console.log("Synced from IDBFS..."); Module.syncdone = 1; ccall('iplug_fsready', 'v'); });},  
 51149: function($0, $1, $2) {if(typeof window[Module.UTF8ToString($0)] === 'undefined' ) { console.log("warning - SAMFUI called before controller exists"); } else { window[Module.UTF8ToString($0)].sendMessage('SAMFUI', "", Module.HEAPU8.slice($1, $1 + $2).buffer); }},  
 51395: function($0) {if(typeof window[Module.UTF8ToString($0)] === 'undefined' ) { console.log("warning - SendDSPIdleTick called before controller exists"); } else { window[Module.UTF8ToString($0)].sendMessage("TICK", "", 0.); }}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=77280;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 77328, 4), 77328);function _gmtime_r(time, tmPtr) {
...
/** @type {function(...*):?} */
var _iplug_syncfs = Module["_iplug_syncfs"] = createExportWrapper("iplug_syncfs");

/** @type {function(...*):?} */
var _iplug_fsready = Module["_iplug_fsready"] = createExportWrapper("iplug_fsready");
...
/** @type {function(...*):?} */
var dynCall_viffiiidd = Module["dynCall_viffiiidd"] = createExportWrapper("dynCall_viffiiidd");
...
/** @type {function(...*):?} */
var dynCall_viiiffif = Module["dynCall_viiiffif"] = createExportWrapper("dynCall_viiiffif");
...
/** @type {function(...*):?} */
var dynCall_viiffffdi = Module["dynCall_viiffffdi"] = createExportWrapper("dynCall_viiffffdi");
...
/** @type {function(...*):?} */
var dynCall_viiffffif = Module["dynCall_viiffffif"] = createExportWrapper("dynCall_viiffffif");

/** @type {function(...*):?} */
var dynCall_viiffffiff = Module["dynCall_viiffffiff"] = createExportWrapper("dynCall_viiffffiff");

/** @type {function(...*):?} */
var dynCall_viiffffffif = Module["dynCall_viiffffffif"] = createExportWrapper("dynCall_viiffffffif");
...
/** @type {function(...*):?} */
var dynCall_viiiffffif = Module["dynCall_viiiffffif"] = createExportWrapper("dynCall_viiiffffif");

/** @type {function(...*):?} */
var dynCall_viifffffif = Module["dynCall_viifffffif"] = createExportWrapper("dynCall_viifffffif");

/** @type {function(...*):?} */
var dynCall_viifffif = Module["dynCall_viifffif"] = createExportWrapper("dynCall_viifffif");
