/* Declares the IPlugMidiEffect Audio Worklet Node */

class IPlugMidiEffectController extends WAMController
{
  ...
  static importScripts (actx) {
    var origin = "https://iplug2.github.io/NANOVG/IPlugMidiEffect/";

    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/IPlugMidiEffect-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/IPlugMidiEffect-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
