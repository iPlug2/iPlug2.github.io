/* Declares the IPlugEffect Audio Worklet Node */

class IPlugEffectController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "IPlugEffect", options);
  }

  static importScripts (actx) {
    var origin = "https://iplug2.github.io/NANOVG/IPlugEffect/";
